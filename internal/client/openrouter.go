...
func (c *OpenRouterClient) GenerateQuote(tag string) (string, error) {
	prompt := fmt.Sprintf(
		"Write a short (1-2 sentence) quote or aphorism for the emotional tag '%s'. "+
			"Keep it concise and suitable for display as a quote. "+
			"Do not include author attribution unless naturally generated by the model. "+
